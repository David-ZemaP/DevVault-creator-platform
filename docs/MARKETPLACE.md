...
3. Apply `supabase/schema.sql` to initialize the database in the Supabase SQL Editor. This sets up all tables, indexes, private storage and commerce structures, and revokes direct anonymous/authenticated access in favor of the service role.
